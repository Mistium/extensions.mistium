(function (Scratch) {
    ...
    */
        ...
        random_incl() {
            ...
            if (this.mti >= this.N) {
                ...
                for (kk = 0; kk < this.N - this.M; kk++) {
                    ...
                    this.mt[kk] =
                        this.mt[kk + this.M] ^ (y >>> 1) ^ mag01[y & 1];
                }
                for (; kk < this.N - 1; kk++) {
                    y =
                        (this.mt[kk] & this.UPPER_MASK) |
            ...
            return {
                ...
                blocks: [
                    // Hidden
                    {
                        ...
                        text: 'Get perlin noise with seed [SEED] and octave [OCTAVE] at x [X], y [Y], and z [Z]',
                        arguments: {
                            SEED: {
                    ...
                    // Hidden
                    {
                        ...
                        blockType: BlockType.REPORTER,
                        text: 'Get noise with seed [SEED] at x [X], y [Y], and z [Z]',
                        arguments: {
                            SEED: {
                                type: ArgumentType.NUMBER,
                                defaultValue: 123
                    ...
                    // Hidden
                    {
                        ...
                        text: 'Pre-generate perlin noise with seed [SEED] and octave [OCTAVE]',
                        arguments: {
                            SEED: {
                                type: ArgumentType.NUMBER,
                                defaultValue: 123
                    ...
                    // Hidden
                    {
                        ...
                        blockType: BlockType.COMMAND,
                        hideFromPalette: true,
                        text: 'Pre-generate seeded noise.',
                        arguments: {
                            SEED: {
                                type: ArgumentType.NUMBER,
                                defaultValue: 123
                    ...
                    // Hidden
                    {
                        ...
                        blockType: BlockType.REPORTER,
                        hideFromPalette: true,
                        text: 'Get simplex noise with seed [SEED] at x [X], y [Y], and z [Z]',
                        arguments: {
                            SEED: {
                                type: ArgumentType.NUMBER,
                                defaultValue: 123
                    ...
                    },
                    {
                        ...
                        blockType: BlockType.REPORTER,
                        text: 'Get random noise with seed [SEED] at x [X], y [Y], and z [Z]',
                        arguments: {
                            SEED: {
                                type: ArgumentType.NUMBER,
                                defaultValue: 123
    ...
    Scratch.extensions.register(new iygPerlin());
})(Scratch);